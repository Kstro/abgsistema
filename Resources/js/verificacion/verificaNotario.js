    ...
    $(document).on("click", "#enviarImagenV", function () {
        ...
        if (flag == true) {
            ...
            $.ajax({
                data: frm,
                dataType: 'json',
                url: Routing.generate('verficacionNotario'),
                type: 'POST',
                cache: false,
                contentType: false,
                processData: false,
                success: function (data) {
                    if (data.estado == true) {
                        ...
                        Lobibox.notify("success", {
                            size: 'mini',
                            msg: '<p>Su solicitud de verificación como notario ha sido enviada.</p>'});
                    } else {
                        Lobibox.notify("error", {
                            size: 'mini',
                            msg: 'Lo sentimos, ha ocurrido un error, intentelo mas tarde.'});
                    }

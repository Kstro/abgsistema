...
//            $reg['numRegistros'] = intval($reg['data']);
            ...
            if($deptoId!=0){
//                echo "busqueda depto";
                $sql = "SELECT * FROM directorio WHERE estado=".$deptoId." AND CONCAT(upper(nombres),' ',upper(apellido)) LIKE '%".strtoupper($busqueda)."%' ORDER BY nombres ASC LIMIT ".$inicioRegistro.",".$longitud;
...
//                $sql = "SELECT COUNT(*) as total FROM directorio WHERE estado=".$deptoId." AND CONCAT(upper(nombres),' ',upper(apellido)) LIKE '%".strtoupper($busqueda)."%' ORDER BY nombres ASC LIMIT 0,10";
            ...
            if($munId!=0){
//                echo "busqueda mun";
                $sql = "SELECT * FROM directorio WHERE estado=".$deptoId." AND ciudad=".$munId." AND CONCAT(upper(nombres),' ',upper(apellido)) LIKE '%".strtoupper($busqueda)."%' ORDER BY nombres ASC LIMIT ".$inicioRegistro.",".$longitud;

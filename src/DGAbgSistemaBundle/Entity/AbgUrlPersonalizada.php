 ...
 * AbgUrlPersonalizada
 *
 * @ORM\Table(name="abg_url_personalizada", indexes={@ORM\Index(name="ctl_empresa_id", columns={"ctl_empresa_id"}), @ORM\Index(name="abg_persona_id", columns={"abg_persona_id"})})
 * @ORM\Entity
 */
class AbgUrlPersonalizada
{
    /**
     * @var integer
     *

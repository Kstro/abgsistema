 ...
 * AbgSubespecialidad
 *
 * @ORM\Table(name="abg_subespecialidad", indexes={@ORM\Index(name="fk_abg_subespecialidad_abg_especialidad1_idx", columns={"abg_especialidad_id"})})
 * @ORM\Entity
 */
class AbgSubespecialidad
{
    /**
     * @var integer
     *

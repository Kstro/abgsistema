 ...
 * AbgSitioWeb
 *
 * @ORM\Table(name="abg_sitio_web", indexes={@ORM\Index(name="fk_abg_sitio_web_ctl_empresa1_idx", columns={"ctl_empresa_id"}), @ORM\Index(name="fk_abg_sitio_web_abg_persona1_idx", columns={"abg_persona_id"})})
 * @ORM\Entity
 */
class AbgSitioWeb
{

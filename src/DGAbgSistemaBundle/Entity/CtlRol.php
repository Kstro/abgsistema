...
class CtlRol implements RoleInterface
{
     ...
     * @return CtlRol
     */
    public function addCtlUsuario(\DGAbgSistemaBundle\Entity\CtlUsuario $ctlUsuario)
    {
     ...
     * @param \DGAbgSistemaBundle\Entity\CtlUsuario $ctlUsuario
     */
    public function removeCtlUsuario(\DGAbgSistemaBundle\Entity\CtlUsuario $ctlUsuario)
    {
